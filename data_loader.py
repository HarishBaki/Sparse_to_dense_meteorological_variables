...
class RTMA_sparse_to_dense_Dataset(Dataset):
    def __init__(self, zarr_store,input_variables_in_order,orography_as_channel, dates_range, orography, 
        ...
        - orography_as_channel (bool): If True, orography is treated as a channel. If False, orography is not considered in channels.
        ...
        self.orography_as_channel = orography_as_channel    # bool
